...
from resources import main_character_image, wall_list
...
class Player(Sprite):
    ...
    def update(self, dt):
        ...
        if are_objects_collided(self, wall_list) and calculate_objects_interposition(self, wall_list) == 'left':
            print('left')
            self.can_move_left = False
        if are_objects_collided(self, wall_list) and calculate_objects_interposition(self, wall_list) == 'right':
            print('right')
            self.can_move_right = False
        if are_objects_collided(self, wall_list) and calculate_objects_interposition(self, wall_list) == 'up':
            print('up')
            self.can_move_up = False
        if are_objects_collided(self, wall_list) and calculate_objects_interposition(self, wall_list) == 'down':
            print('down')
